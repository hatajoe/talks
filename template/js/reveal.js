...
(function( root, factory ) {
	...
	function createBackground( slide, container ) {
		...
		var data = {
			...
			backgroundType: slide.getAttribute( 'data-background-type' )
		};
		...
		slide.classList.remove( 'has-green-background' );
		...
		if( data.backgroundType == 'dark' ) slide.classList.add( 'has-dark-background' );
		if( data.backgroundType == 'green' ) slide.classList.add( 'has-green-background' );
		if( data.backgroundType == 'light' ) slide.classList.add( 'has-light-background' );
		return element;
	...
	function updateBackground( includeAll ) {
		...
		if( currentSlide ) {
			[ 'has-light-background', 'has-green-background', 'has-dark-background' ].forEach( function( classToBubble ) {
